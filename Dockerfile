...
RUN gcc -Ilib -c ./lib/error_functions.c && \
    ...
    gcc -Ilib -c ./lib/binary_sems.c

# # build static library
RUN ar -cr ${LIBRARY_NAME} error_functions.o get_num.o file_perms.o curr_time.o print_wait_status.o st_handler.o itimerspec_from_str.o binary_sems.o
